...
const ServiceLayout = ({ parts, servicesData }) => {
  ...
  const createService = async (e) => {
    ...
    setLoad(true);
    axios
      .post(process.env.NEXT_PUBLIC_TI_CREATE_SERVICE, {
        name: name,
        ...
        <div>
          <Row>
            <Col>
              ...
              <button
                className="global-btn mx-2 my-1"
                onClick={handleShow}
              >
                {' '}
                Add new
                        ...
                        <div className=" mx-2">
                          ...
                          <div className="detail-service">
                            ...
                            <span className="right">
                              {minVal(serv.Servicecars).toFixed(2)} $
                              - {maxVal(serv.Servicecars).toFixed(2)}{' '}
                              $
                            </span>
                          </div>
                          <hr className="my-2" />
                          <div className="detail-service">
                            ...
                            <span className="right">
                              {minValCost(serv.Servicecars).toFixed(
                                2
                              )}{' '}
                              $ -{' '}
                              {maxValCost(serv.Servicecars).toFixed(
                                2
                              )}{' '}
                              $
                            </span>
                          ...
                          <div className="detail-service">
                            ...
                            <span className="right">
                              {minValparts(serv.Servicecars).toFixed(
                                2
                              )}{' '}
                              $ -{' '}
                              {maxValparts(serv.Servicecars).toFixed(
                                2
                              )}{' '}
                              $
                            </span>
                          ...
                          <div
                            ...
                            onClick={() =>
                              Router.push(`/services/${serv.id}`)
                            }
                          >
                            <button className="global-btn px-5 my-3">
                              {' '}
                              See Details{' '}
                            </button>
                          </div>
      ...
      {show && (
        ...
        >
          ...
          <Form onSubmit={createService}>
                ...
                <div className="box px-5 mx-3">
                  ...
                  <div>
                            ...
                            <Col>
                              ...
                              >
                                ...
                                <Form.Control
                                  ...
                                  placeholder=""
                                  value={
                                    state.serviceList[index].make
                                  }
                                  onChange={(e) => {
                                    let tempState = state.serviceList;
                                    tempState[index].make =
                                      e.target.value;
                                    setState({
                                      serviceList: tempState,
                                    });
                                  }}
                                />
                              </Form.Group>
                              ...
                              >
                                ...
                                <span>
                                  <Form.Control
                                    ...
                                    placeholder=""
                                    value={
                                      state.serviceList[index].from
                                    }
                                    onChange={(e) => {
                                      let tempState =
                                        state.serviceList;
                                      tempState[index].from =
                                        e.target.value;
                                      setState({
                                        serviceList: tempState,
                                      });
                    ...
                    <Row className="justify-content-md-center mt-5">
                      <hr />
                      <Col md="auto">
                        <div className="plus" onClick={extendCar}>
                          +
                        </div>
                      </Col>
                    </Row>
                        ...
                        <Col>
                          ...
                          >
                            ...
                            <Form.Control
                              ...
                              placeholder=""
                              value={
                                state.serviceList[index].labourCost
                              }
                              onChange={(e) => {
                                let tempState = state.serviceList;
                                tempState[index].labourCost =
                        ...
                        <Col>
                          ...
                          >
                            ...
                            <Form.Control
                              ...
                              placeholder=""
                              value={
                                state.serviceList[index].discount
                              }
                              onChange={(e) => {
                                let tempState = state.serviceList;
                                tempState[index].discount =
                                  parseFloat(e.target.value);
                                setState({ serviceList: tempState });
                                setPriceChange(!priceChange);
                              }}
            ...
            <Button type="submit" className="my-2 mx-3">
              {load ? (
                <Spinner
                  className="mx-4"
                  as="span"
